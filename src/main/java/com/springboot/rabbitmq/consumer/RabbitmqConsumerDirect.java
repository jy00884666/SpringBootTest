...
public class RabbitmqConsumerDirect {
    ...
    public void process(String testMessage, Message message) {
        System.out.println("direct消费者收到消息1: testMessage=" + testMessage.toString());
        // 消息的编号
        long msgTag = message.getMessageProperties().getDeliveryTag();
        System.out.println("direct消费者收到消息1: msgTag=" + msgTag);
        System.out.println("direct消费者收到消息1: message=" + message.toString());
    }
    
    @RabbitHandler
    public void process(Map testMessage, Message message) {
        System.out.println("direct消费者收到消息1: Map=" + JSON.toJSONString(testMessage));
        // 消息的编号
        long msgTag = message.getMessageProperties().getDeliveryTag();
        System.out.println("direct消费者收到消息1: msgTag=" + msgTag);
        System.out.println("direct消费者收到消息1: message=" + message.toString());
